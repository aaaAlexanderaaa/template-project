...
- Declared engineering risk budget: {{budget or none; absence uses governance
  [governance § decision-envelope](../docs/contracts/governance-decision-boundary.md#delegated-engineering-work-proceeds-by-default)'s locally reversible, no-uncontracted-durable-effect default}}
